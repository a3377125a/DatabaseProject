...
Source Database       : database_project

Target Server Type    : MYSQL
Target Server Version : 80031
File Encoding         : 65001

Date: 2023-02-16 18:12:01
*/
...
CREATE TABLE `class` (
  ...
  `deptId` int NOT NULL,
  `i_id` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `department` (
  ...
  `dept_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `a_id` char(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `log` (
  ...
  `s_id` char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `campusId` int DEFAULT NULL,
  `time` datetime DEFAULT NULL,
  `action` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `student` (
  ...
  `tellphone` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `familyAdress` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `t_come` (
  ...
  `Addresses` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `t_come` VALUES ('2', '20301234567', '假期返校', '上海', '2023-02-18', '2', null, '2023-02-15 15:45:43');
...
CREATE TABLE `t_leave` (
  ...
  `s_id` char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `destAdress` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Records of t_leave
-- ----------------------------
INSERT INTO `t_leave` VALUES ('1', '20301234567', 'xxxxxxx', 'yyy', '2023-02-07', '2023-02-13', '2', null, '2023-02-06 16:13:42');
INSERT INTO `t_leave` VALUES ('2', '20301234568', 'awertyhjngbfvdcfsd', 'asdfghmn', '2023-02-15', '2023-02-21', '3', null, '2023-02-15 16:16:14');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `student_state` AS select `log`.`s_id` AS `s_id`,`t`.`time1` AS `time1`,`log`.`action` AS `action` from (`log` join (select `log`.`s_id` AS `s_id`,max(`log`.`time`) AS `time1` from `log` group by `log`.`s_id`) `t` on(((`log`.`s_id` = `t`.`s_id`) and (`t`.`time1` = `log`.`time`)))) ;
